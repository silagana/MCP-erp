...
| 14 | Canal de prueba por Telegram (`app/telegram_webhook.py`), deploy separado del de WhatsApp para poder desactivarlo sin tocar nada — reusa el mismo orchestrator/tools/permisos. Vinculación por `/vincular <telefono>` a un usuario ya existente | ✅ hecho |
